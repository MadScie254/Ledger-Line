    ...
    <div className="space-y-6">
      <header>
        <div className="flex flex-col justify-between gap-4 xl:flex-row xl:items-end">
          <div>
            <h1 className="font-serif text-4xl font-semibold text-ink-900">Time tracking</h1>
            <p className="mt-3 text-sm text-slate-500">Log billable hours against projects.</p>
          </div>
        </div>
